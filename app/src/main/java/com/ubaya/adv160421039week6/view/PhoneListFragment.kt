...
import com.ubaya.adv160421039week6.databinding.FragmentPhoneListBinding
import com.ubaya.adv160421039week6.viewmodel.PhoneViewModel
...
class PhoneListFragment : Fragment() {
    ...
    fun observeViewModel() {
        ...
        viewModel.phoneLoadErrorLD.observe(viewLifecycleOwner, Observer {if(it == true) {
